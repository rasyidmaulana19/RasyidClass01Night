...
# ================== PAGE 2: TEAM MEMBERS ==================
    ...
    with col1:
        st.markdown("""
        <div style='background: rgba(30,41,59,0.7); padding: 1.5rem; border-radius: 15px; 
                    border: 1px solid rgba(59, 130, 246, 0.3); box-shadow: 0 4px 15px rgba(0,0,0,0.3); text-align: center;'>
        """, unsafe_allow_html=True)
        display_member_photo(photo_rasyid, "Rasyid Irvan Maulana")
        st.markdown("""
            <h3 style='color: #e4e4e7; margin-top: 15px;'>Rasyid Irvan Maulana</h3>
    ...
    with col2:
        st.markdown("""
        <div style='background: rgba(30,41,59,0.7); padding: 1.5rem; border-radius: 15px; 
                    border: 1px solid rgba(167, 139, 246, 0.3); box-shadow: 0 4px 15px rgba(0,0,0,0.3); text-align: center;'>
        """, unsafe_allow_html=True)
        display_member_photo(photo_luthfi, "Luthfi Ilham Pratama")
        st.markdown("""
            <h3 style='color: #e4e4e7; margin-top: 15px;'>Luthfi Ilham Pratama</h3>
    ...
    with col3:
        ...
        st.markdown("""
            <h3 style='color: #e4e4e7; margin-top: 15px;'>Andrian Ramadhan</h3>
    ...
    with col4:
        ...
        st.markdown("""
            <h3 style='color: #e4e4e7; margin-top: 15px;'>Restu Imam Fakhrezi</h3>
